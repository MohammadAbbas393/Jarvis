...
dotenv_path = '/Users/abbas/Documents/PROJECTS/dlinq/OPENAI_API_KEY.env'
load_dotenv(dotenv_path=dotenv_path)

# Now attempt to retrieve the OPENAI_API_KEY from environment variables
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")

# Check if the OPENAI_API_KEY was correctly loaded
if not OPENAI_API_KEY:
    print("OpenAI API key not found. Please set it in your environment variables or check your .env file.")
    sys.exit(1)
...
def recognize_speech_from_mic(recognizer, microphone):
    try:
        ...
        return "I'm sorry, I didn't catch that, can you say it again."
...
def create_gui():
    root = Tk()
    root.title("Abbas's JARVIS AI Assistant")
